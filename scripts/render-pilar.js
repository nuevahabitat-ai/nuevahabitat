...
<section class="lc-section" style="background:var(--blanco)">
  <div class="container" style="max-width:800px">
    ${checklistBlock(L.checklist?.title || 'Checklist antes de vender en Ciutat Vella', L.checklist?.items, L.checklist?.intro)}
    <div class="text-center fade-up" style="margin-bottom:2rem;margin-top:${L.checklist?.items?.length ? '3rem' : '0'}"><span class="overline">FAQ</span><h2 class="section-title">Vender piso en Ciutat Vella — preguntas frecuentes</h2></div>
