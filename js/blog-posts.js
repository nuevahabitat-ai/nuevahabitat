/** Contenido de artículos del blog NuevaHabitat */
window.NH_BLOG_POSTS = {
  'precio-pisos-barcelona': {
    title: '¿Cuánto vale tu piso en Barcelona en 2026? Análisis por barrios',
    cat: 'Mercado',
    date: '10 jul 2026',
    readMin: 7,
  ...
  'contrato-arras': {
    title: 'Contrato de arras: tipos, plazos y cómo protegerte si alguien incumple',
    cat: 'Jurídico',
    date: '5 jul 2026',
    readMin: 6,
    image: 'imagenes/interior1.jpg',
    excerpt: 'Penitenciales, confirmatorias o penales: cada tipo tiene consecuencias distintas si la operación se cae.',
    body: `
  ...
  'guia-hipotecas': {
    title: 'Guía definitiva de hipotecas en España para 2026: fija, variable o mixta',
    cat: 'Hipotecas',
    date: '28 jun 2026',
    readMin: 8,
    image: 'imagenes/inmobiliario4.jpg',
    excerpt: 'Con el euríbor estabilizado, ¿qué modalidad conviene más según tu perfil?',
    body: `
  ...
  'como-vender-rapido': {
    title: '7 claves para vender tu piso en menos de 60 días en Barcelona',
    cat: 'Vender',
    date: '20 jun 2026',
    readMin: 5,
    image: 'imagenes/inmobiliario2.jpg',
    excerpt: 'Precio correcto, fotografía profesional y compradores filtrados: la fórmula que funciona.',
    body: `
  ...
  'home-staging': {
    title: 'Home staging: cómo preparar tu piso para venderlo un 15% más caro',
    cat: 'Vender',
    date: '15 jun 2026',
    readMin: 4,
    image: 'imagenes/interior8.jpg',
    excerpt: 'Pequeños cambios que marcan una gran diferencia en el precio final y el tiempo de venta.',
    body: `
  ...
  'primera-vivienda': {
    title: 'Primera vivienda en Barcelona: todo lo que nadie te cuenta antes de comprar',
    cat: 'Comprar',
    date: '10 jun 2026',
    readMin: 7,
    image: 'imagenes/familia3.jpg',
    excerpt: 'Desde el ahorro necesario hasta los impuestos que te olvidarás de calcular.',
    body: `
  ...
  'mercado-2026': {
    title: 'El mercado inmobiliario de Barcelona en el primer semestre de 2026',
    cat: 'Mercado',
    date: '1 jun 2026',
    readMin: 6,
    image: 'imagenes/interior9.jpg',
    excerpt: 'Análisis de precios, oferta y demanda por zonas. ¿Es buen momento para comprar?',
    body: `
  ...
  'gastos-compraventa': {
    title: 'Gastos de compraventa en Cataluña: quién paga qué en 2026',
    cat: 'Jurídico',
    date: '25 may 2026',
    readMin: 5,
    image: 'imagenes/familia1.jpg',
    excerpt: 'ITP, notaría, registro y gestoría: calculamos exactamente cuánto supone cada partida.',
    body: `
  ...
  'negociar-precio': {
    title: 'Cómo negociar el precio de un piso sin quemar la operación',
    cat: 'Comprar',
    date: '18 may 2026',
    readMin: 4,
    image: 'imagenes/familia2.jpg',
    excerpt: 'Técnicas que usan los agentes profesionales para conseguir descuentos reales.',
    body: `
  ...
  'euribor-2026': {
    title: '¿Qué pasará con el euríbor en la segunda mitad de 2026?',
    cat: 'Hipotecas',
    date: '10 may 2026',
    readMin: 5,
